...
export default function App() {
  ...
  return (
    <div className="w-screen h-screen relative">
      <button
        onClick={() => {
          if (confirm("Xóa toàn bộ danh sách người trúng thưởng?")) {
            resetAll();
          }
        }}
      >
        <img
          src="/images/logo.png"
          alt="Logo"
          className="absolute w-12 h-auto top-2 left-4 bg-cover bg-center z-90 cursor-pointer "
        />
      </button>
      <img
        src="/images/bg-3.png"
      ...
      />
      <h1
        className="absolute w-full text-5xl font-black text-[#214497] text-shadow-2xs pt-4 z-60 top-0 left-0 text-center flex justify-center items-center"
        style={{
          textShadow: "-1px -1px 0 #fff, 3px -1px 0 #fff, -1px 3px 0 #fff, 3px 3px 0 #fff",
        }}
      >
      ...
      <div className="absolute bottom-3 w-full z-90 flex justify-center items-start">
        <button
